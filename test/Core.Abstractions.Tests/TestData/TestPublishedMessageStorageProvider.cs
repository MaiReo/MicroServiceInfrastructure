...
{
    public class TestPublishedMessageStorageProvider : IPublishedMessageStorageProvider, IMessageStorageProvider
    {
        private readonly IAsyncRepository<TestPublishedMessageLog, Guid> repository;

        public TestPublishedMessageStorageProvider(IAsyncRepository<TestPublishedMessageLog, Guid> repository)
        {
        ...
        {
            var entity = new TestPublishedMessageLog
            {
                Hash = model.Hash,
                Group = model.Group,
                Topic = model.Topic,
