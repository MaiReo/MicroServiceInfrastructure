...
{
    public class FakeConsumedMessageStorageProvider : IConsumedMessageStorageProvider, IMessageStorageProvider, ILifestyleSingleton
    {
        public FakeConsumedMessageStorageProvider()
        {
